...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'kavs@w7mmm.onmicrosoft.com',
  ...
  footer:
    'Powered by <a href="https://telegram.dog/develoforallbackup" target="_blank" rel="noopener noreferrer">Develo</a>. Made with ❤ by Develo.',

  // [OPTIONAL] This is where you specify the folders that are password protected. It is an array of paths pointing to all
  // the directories in which you have .password set. Check the documentation for details.
  // protectedRoutes: ['/🌞 Private folder/u-need-a-password', '/🥟 Some test files/Protected route'],
  protectedRoutes: ['/Public/Paid'],
  ...
  links: [
    {
      name: 'Contact',
      link: 'https://telegram.dog/develoforallbackup',
    },
  ],
